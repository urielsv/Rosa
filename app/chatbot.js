...
function start(client) {
  ...
  client.onMessage(async (message) => {
    ...
    if (clientMap.get(message.chatId) == 4) {
      ...
      if (message.body === "No") {
        sendTextTl(client, message, "sin-turno-virtual");
      } else if (message.body === "Si") {
        sendTextTl(client, message, "turnoconfirmado");
      ...
      clientMap.set(message.chatId, -1);
    }
    ...
    if (clientMap.get(message.chatId) == 3) {
      ...
      sendTextTl(client, message, "pregunta-turno");
    }
    ...
    if (clientMap.get(message.chatId) == 2) {
      ...
      //   "Si " +
      //   sintomasText +
      //   ' no tiene relacion con sintomas de alguna enfermedad, responder con un mensaje que diga "false" ' +
      //   " Si" +
      //   sintomasText +
      //   ' corresponde a un sintoma de una enfermedad, que el mensaje diga "true"';
    ...
    if (message.body === "Cancelar" && nappointmentGive) {
